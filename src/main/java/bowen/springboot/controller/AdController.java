...
public class AdController {
	 ...
	 * @param ad
	 */
	@RequestMapping(method=RequestMethod.PUT, value="/ad/{partner_id}")
	public void updateAd(@RequestBody Ad ad, @PathVariable String partner_id) {
		adService.updateAd(ad, partner_id);
	}
